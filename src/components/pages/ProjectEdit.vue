...
export default {
  ...
  try {
    ...
    if (this.oldNamabarang !== this.form.namabarang && barangLama) {
      await axios.put(`http://localhost:3000/users/${barangLama.id}`, {
        ...barangLama,
    ...
    if (this.oldNamabarang === this.form.namabarang) {
      ...
      await axios.put(`http://localhost:3000/users/${barangBaru.id}`, {
        ...barangBaru,
    ...
    await axios.put(`http://localhost:3000/database/${id}`, this.form);
